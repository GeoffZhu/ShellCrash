...
bfstart(){
	...
	[ -z "$update_url" ] && update_url=https://fastly.jsdelivr.net/gh/GeoffZhu/ShellCrash@master
	#检查yaml配置文件
	if [ ! -f $yaml ];then
	...
	if [ ! -f $bindir/clash ];then
		if [ -f $clashdir/clash ];then
			...
			[ "$update_url" = "https://jwsc.eu.org:8888" ] && [ "$clashcore" != 'clash' ] && update_url=https://fastly.jsdelivr.net/gh/GeoffZhu/ShellCrash@master
...
webget)
		...
		if [ -n "$(pidof clash)" ];then
			...
			url=$(echo $3 | sed 's#https://fastly.jsdelivr.net/gh/GeoffZhu/ShellCrash[@|/]#https://raw.githubusercontent.com/GeoffZhu/ShellCrash/#' | sed 's#https://gh.jwsc.eu.org/#https://raw.githubusercontent.com/GeoffZhu/ShellCrash/#')
		else
			url=$(echo $3 | sed 's#https://raw.githubusercontent.com/GeoffZhu/ShellCrash/#https://fastly.jsdelivr.net/gh/GeoffZhu/ShellCrash@#')
		fi
